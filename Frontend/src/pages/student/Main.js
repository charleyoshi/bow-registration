...
export default function Main(props) {
  ...
  const loginUser = (student) => {
    setIsLoggedIn(true);
    console.log("loginUser: " + JSON.stringify(student));
  ...
  return (
    <>
      {isLoggedIn ? (
        <>
          <TopNavbar
            title="Bow online course registration"
            navs={["Home", "Logout"]}
          />
        ...
        <>
          ...
          {showLogin ? (
            <StudentLoginForm
              ...
              credentials={props.studentUsers}
              loginUser={loginUser}
            />
          ) : (
            <StudentRegisterForm
          ...
          <div>
            {showLogin && !isLoggedIn ? (
              <p>
                ...
                <br />
                <strong
                  style={{ color: "#ff895d", cursor: "pointer" }}
              ...
              <p>
                ...
                <br />
                <strong
                  style={{ color: "#007cb9", cursor: "pointer" }}
